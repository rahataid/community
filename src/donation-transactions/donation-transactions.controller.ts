...
export class DonationTransactionsController {
  constructor(private readonly donationTransactionsService: DonationTransactionsService) {}

  @Post()
  create(@Body() createDonationTransactionDto: CreateDonationTransactionDto) {
    return this.donationTransactionsService.create(createDonationTransactionDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateDonationTransactionDto: UpdateDonationTransactionDto) {
    return this.donationTransactionsService.update(+id, updateDonationTransactionDto);
  }
